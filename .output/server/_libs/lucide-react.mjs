...
const Bolt = createLucideIcon("bolt", __iconNode$l);
const __iconNode$k = [
...
const GitCompare = createLucideIcon("git-compare", __iconNode$a);
const __iconNode$9 = [
  [
    "path",
    {
...
const Siren = createLucideIcon("siren", __iconNode$3);
const __iconNode$2 = [
  [
    "path",
    {
