...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CcNia_8N.mjs");
...
const manifest = {
  "7ae4ad10439d6124e7dce91144dcc123f3581053eb720dcd8d8d3b19f6263fe8": {
    functionName: "compareDocuments_createServerFn_handler",
    importer: () => import("./analyse.functions-CeIm28rC.mjs")
  },
  "a8745f03bbf65999e2be8d58fc8c995faccd0c4bf6c5cc888cc9939efe268608": {
    functionName: "analyseDocument_createServerFn_handler",
    importer: () => import("./analyse.functions-CeIm28rC.mjs")
  },
  "d2ff833751e4fa8be9863691e89bab18fdc3a35b445146213ef04c62fa0cf068": {
    functionName: "chatFollowUp_createServerFn_handler",
    importer: () => import("./analyse.functions-CeIm28rC.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-D8iB13Hz.mjs"),
    import("./start-CIG65mKb.mjs"),
